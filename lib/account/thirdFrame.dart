...
class ThirdFrame extends StatefulWidget {
  final Function(int) moveToPage;

  const ThirdFrame({Key? key, required this.moveToPage}) : super(key: key);

  @override
  _ThirdFrameState createState() => _ThirdFrameState();
}

class _ThirdFrameState extends State<ThirdFrame> {
...
void initState() {
  super.initState();
  final weightToLose = _getStorage.read('weightToLose');
  if (weightToLose != null) {
    _controller.text = weightToLose.toString();
  }
}
                ...
                Container(
                  ...
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      onChanged: (value) {
                        setState(() {
                          _getStorage.write('weightToLose', value);
                          print('Weight to lose: ' +
                              _getStorage.read('weightToLose'));
                        });
                      },
                    ),
                  ),
